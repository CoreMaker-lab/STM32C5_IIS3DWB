...
#define CS_PORT                                         HAL_GPIOB
#define CS_PIN                                          HAL_GPIO_PIN_0
#define CS_INIT_STATE                                   HAL_GPIO_PIN_RESET
#define CS_ACTIVE_STATE                                 HAL_GPIO_PIN_SET
#define CS_INACTIVE_STATE                               HAL_GPIO_PIN_RESET
